	...
	public void init() {
		...
		this.setItem(
				new ItemBuilder(Material.EMERALD_BLOCK, 1).
						setName(LocalizedUtils.getLocalizedMessage("gui-punish-kick-accept-displayname", locale)).
						setDescription(LocalizedUtils.getLocalizedMessage("gui-punish-kick-accept-lore", locale)).
