	...
	public void init() {
		...
		this.setItem(
				new ItemBuilder(Material.EMERALD_BLOCK, 1).
						setName(LocalizedMessage.getLocalizedMessage("gui-punish-mute-accept-displayname", locale)).
						setDescription(LocalizedMessage.getLocalizedMessage("gui-punish-mute-accept-lore", locale)).
