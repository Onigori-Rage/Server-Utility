	...
	public void init() {
		...
		this.setItem(
				new ItemBuilder(Material.EMERALD_BLOCK, 1).
						setName(LocalizedUtil.getLocalizedMessage("gui-punish-ban-accept-displayname", locale)).
						setDescription(LocalizedUtil.getLocalizedMessage("gui-punish-ban-accept-lore", locale)).
